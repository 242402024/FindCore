...
const plans = [
  ...
  //   price: "Anual 2 236,6€",
  //   description:
  //     "Impostos inclusos\nHaverá cobrança de taxa se você cancelar após 14 dias.",
  // },
  // {
  //   id: 2,
  //   name: "50 Licenças",
  ...
  //   price: "Anual 22 366€",
  //   description:
  //     "Impostos inclusos\nNão haverá reembolso se você cancelar após 14 dias.",
  // },
];
...
function ProductPage() {
  ...
  const handleQuoteChange = (e) => {
    ...
    setQuoteDetails((prevDetails) => ({ ...prevDetails, [name]: value }));
  };
                  ...
                  <Container className="mt-5 add-product-manager">
                    ...
                    <Form onSubmit={handleSubmit}>
                        ...
                        <Col>
                          ...
                          <Form.Group controlId="preco_compra">
                            ...
                            <Form.Control
                              type="text"
                              placeholder="0.00€"
                              value={formData.preco_compra = ((uniqueProdutos.precoProduto)*(formData.quantidade)).toFixed(2) + "€"}
                              onChange={handleChange}
                              readOnly
                              disabled
                            />
                      ...
                      >
                        ...
                        <Form.Control
                          type="text"
                          value={formData.software = uniqueProdutos.nameProduto}
                          readOnly
                          disabled
                        />
                      </Form.Group>
